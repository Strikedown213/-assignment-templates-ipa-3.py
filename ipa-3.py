...
print(relationship_status('@joaquin','@chums', graph))
print(relationship_status('@eeebeee', '@jobenilagan', graph))
print(relationship_status('@eeebeee', '@chums', graph))
print(relationship_status('@joaquin', '@chums', graph))
print(relationship_status('@chums', '@joaquin', graph))
...
print("1:", tic_tac_toe(board_1))
print("2:",tic_tac_toe(board_2))
print("3:",tic_tac_toe(board_3))
print("4:",tic_tac_toe(board_4))
print("5:",tic_tac_toe(board_5))
